...
GUI   *AJUSTAR O TAMANHO DO ARQUIVO CONFORME DOCUMENTO WORD
       01  FD-CADCLI-REGISTRO     PIC X(077).
      *
      *--------------------------------------------------------------*
      *    ARQUIVO ALTCLI
      *--------------------------------------------------------------*
...
GUI   *AJUSTAR O TAMANHO DO ARQUIVO CONFORME DOCUMENTO WORD
      ...
      *
GUI   *AJUSTAR O TAMANHO DO ARQUIVO CONFORME DOCUMENTO WORD
       01  FD-CADCLIN-REGISTRO    PIC X(091).
      *
      *--------------------------------------------------------------*
...
GUI   *DEFINIR O LAYOUT DO ARQUIVO ALTCLI CONFORME DOCUMENTO WORD
      *
       01  WRK-ALTCLI-REGISTRO.                            
           ...
           05 ALTCLI-RENDA-MENSAL            PIC  9(011)V99. 
...
JUH   *    AJUSTAR O UNTIL PARA PROCESSAR ATE O FIM DO ARQUIVO 1 E ARQUIVO 2
           PERFORM 030-PROCESSAR 
             UNTIL XXXXXXXXXXXXXXXXXXXXXXXXX.
...
GUI   *    INCLUIR OPEN DO ARQUIVO CADCLI
      ...
      *
       030-PROCESSAR.
JUH   * ESCREVER A LOGICA DO PROCESSAR CONFORME DOCUMENTO EM ANEXO
...
JUH   * MOVIMENTAR OS DADOS DO ARQUIVO ALTCLI PARA O ARQUIVO CADCLIN
JUH   * ESSE PARAGRAFO DEVE SER ACIONADO DENTRO DO 030-PROCESSAR QUANDO
JUH   * CADCLI-CHAVE = ALTCLI-CHAVE OU CADCLI-CHAVE > ALTCLI-CHAVE
...
JUH   *    MONTAR O DISPLAY DOS CONTADORES CONFORME WORD
           .
      *
       052-FECHAR-ARQUIVOS.
           CLOSE CADCLI.
           ...
           END-IF.
      *
JUH   *    INCLUIR O CLOSE DO ARQUIVO ALTCLI
      *
           CLOSE CADCLIN
