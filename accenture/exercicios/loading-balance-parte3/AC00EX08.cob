       ...
       01  FD-RELCLI-REGISTRO     PIC X(056).
       ...
       01 WRK-RELCLI-REGISTRO.
           ...
           05 RELCLI-RENDA-MENSAL PIC S9(009)V99.
       ...
       01  WRK-INDICADORES.
           03 WRK-ULT-GRAV-RELCLI PIC 9(05).
       ...
       020-PROCESSAR.
           ...
           ELSE
               IF CADCLIE-CHAVE > CADPROD-CHAVE
                   PERFORM 042-LER-CADPROD
               ELSE
                   IF CADPROD-COD-PRODUTO NOT = 00005 OR NOT = 00009 
                     AND CADCLIE-COD-CLIENTE NOT = WRK-ULT-GRAV-RELCLI
       ...
       044-GRAVAR-RELCLI.
           ...
           MOVE RELCLI-COD-CLIENTE TO WRK-ULT-GRAV-RELCLI.
